      ...
      <div className="container text-justify flex flex-col gap-y-10">
        <div className="flex flex-wrap">
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <p className="mb-5 text-base font-medium text-secondry lg:text-lg">Menjadi pemimpin dalam industri aluminium dan kaca, dengan fokus pada inovasi, kualitas, dan kepuasan pelanggan.</p>
        ...
        <div className="flex flex-wrap">
          <h2 className="w-full mb-6 text-3xl font-bold text-center text-primary lg:text-4xl">
            Tim<span className="text-dark"> Kami</span>
          </h2>
          <div className="grid grid-cols-3 gap-4 w-full">
            <div className="col-span-3 md:col-span-1 rounded-lg bg-secondary p-6 flex gap-x-6 items-center mx-6">
              <div className="h-24 w-24 bg-white rounded-full"></div>
              <div className="flex flex-col gap-y-2">
                <span className="text-xl font-semibold">Timbul Santoso</span>
                <span className="font-thin text-lg">Owner</span>
              </div>
            </div>
            <div className="col-span-3 md:col-span-1 rounded-lg bg-secondary p-6 flex gap-x-6 items-center mx-6">
              <div className="h-24 w-24 bg-white rounded-full"></div>
